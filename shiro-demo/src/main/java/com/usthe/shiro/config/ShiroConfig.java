...
import com.usthe.shiro.filter.StatelessWebSubjectFactory;
import com.usthe.shiro.realm.AonModularRealmAuthenticator;
import com.usthe.shiro.realm.RealmManager;
...
public class ShiroConfig {
    ...
    public SecurityManager securityManager(RealmManager realmManager) {
        ...
        securityManager.setRealms(realmManager.getInitRealms());
