...
public class DataJpaApplication {
    ...
    @Bean
    public CommandLineRunner execQuery(CarRepository repository){
        return args-> repository.findByMake("Honda").forEach(System.err::println);
    }

    public static void main(String []a){
        SpringApplication.run(DataJpaApplication.class,a);
    }
